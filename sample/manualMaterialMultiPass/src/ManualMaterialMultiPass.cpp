#include "ManualMaterialMultiPass.hpp"
...
ManualMaterialMultiPass::ManualMaterialMultiPass() :
    FrameListener(),
    ...
    m_material("ManualMaterialMultiPass")
{
...
void ManualMaterialMultiPass::start()
{
    ...
    m_resourceLoader.initialise("ManualMaterialMultiPass");
...
void ManualMaterialMultiPass::stop()
{
	destroyObject();
...
void ManualMaterialMultiPass::run()
{
    int i=0;
    while (++i < 10000)
    {
...
void ManualMaterialMultiPass::loadScene()
{
...
void ManualMaterialMultiPass::unloadScene()
{
...
void ManualMaterialMultiPass::createObject()
{
    // Light
	//----------------------------------
	{
	...
	//----------------------------------
	{
        ::Ogre::Entity* cube = m_sceneManager->createEntity("OGRENGINE_Cube", "cube.mesh", "ManualMaterialMultiPass");
        cube->setMaterialName("ManualMaterialMultiPass");
...
void ManualMaterialMultiPass::destroyObject()
{
    // Cube
    //----------------------------------
    {
...
bool ManualMaterialMultiPass::frameStarted(const Ogre::FrameEvent&)
{
	return true;
}

bool ManualMaterialMultiPass::frameEnded(const Ogre::FrameEvent&)
{
	return true;
}

bool ManualMaterialMultiPass::frameRenderingQueued(const Ogre::FrameEvent&)
{
    // Rotate the cube
	//---------------------------------
	{
