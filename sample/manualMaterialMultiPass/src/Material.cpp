...
void Material::load()
{
    ...
    pass0->setAmbient(::Ogre::ColourValue(0.2f, 0.0f, 0.0f, 1.0));
    pass0->setDiffuse(::Ogre::ColourValue(1.0f, 0.0f, 0.0f, 1.0));
    pass0->setSpecular(::Ogre::ColourValue(1.0f, 0.0f, 0.0f, 1.0));
    pass0->setShininess(33);

    pass1->setAmbient(::Ogre::ColourValue(0.0f, 0.2f, 0.0f, 1.0));
    pass1->setDiffuse(::Ogre::ColourValue(0.0f, 1.0f, 0.0f, 1.0));
    pass1->setSpecular(::Ogre::ColourValue(0.0f, 1.0f, 0.0f, 1.0));
    pass1->setShininess(33);
    pass1->setSceneBlending(::Ogre::SceneBlendType::SBT_ADD);

    pass2->setAmbient(::Ogre::ColourValue(0.0f, 0.0f, 0.2f, 1.0));
    pass2->setDiffuse(::Ogre::ColourValue(0.0f, 0.0f, 1.0f, 1.0));
    pass2->setSpecular(::Ogre::ColourValue(0.0f, 0.0f, 1.0f, 1.0));
    pass2->setShininess(33);
    pass2->setSceneBlending(::Ogre::SceneBlendType::SBT_ADD);

    {
        ...
        pass0->setVertexProgram(vertex->getName());
...

    {
        ...
        pass0->setFragmentProgram(fragment->getName());
        pass1->setFragmentProgram(fragment->getName());
        pass2->setFragmentProgram(fragment->getName());
    }

    {
        ::Ogre::TextureUnitState* pTex1 = pass0->createTextureUnitState();
        ...
        ::Ogre::TextureUnitState* pTex2 = pass0->createTextureUnitState();
        ...
        ::Ogre::TextureUnitState* pTex3 = pass0->createTextureUnitState();
        ...
        ::Ogre::TextureUnitState* pTex4 = pass0->createTextureUnitState();
...

    {
        ...
        pTex1->setTextureName("rock_diffuse.jpg");
        pTex1->setTextureFiltering(::Ogre::FilterOptions::FO_LINEAR, ::Ogre::FilterOptions::FO_LINEAR, ::Ogre::FilterOptions::FO_LINEAR);
        ::Ogre::TextureUnitState* pTex2 = pass1->createTextureUnitState();
        pTex2->setTextureName("rock_diffuse.jpg");
        pTex2->setTextureFiltering(::Ogre::FilterOptions::FO_LINEAR, ::Ogre::FilterOptions::FO_LINEAR, ::Ogre::FilterOptions::FO_LINEAR);
        ::Ogre::TextureUnitState* pTex3 = pass1->createTextureUnitState();
        pTex3->setTextureName("rock_normal.jpg");
        pTex3->setTextureFiltering(::Ogre::FilterOptions::FO_LINEAR, ::Ogre::FilterOptions::FO_LINEAR, ::Ogre::FilterOptions::FO_LINEAR);
        ::Ogre::TextureUnitState* pTex4 = pass1->createTextureUnitState();
        pTex4->setTextureName("rock_specular.png");
        pTex4->setTextureFiltering(::Ogre::FilterOptions::FO_LINEAR, ::Ogre::FilterOptions::FO_LINEAR, ::Ogre::FilterOptions::FO_LINEAR);
    }

    {
        ::Ogre::TextureUnitState* pTex1 = pass2->createTextureUnitState();
        pTex1->setTextureName("rock_diffuse.jpg");
        pTex1->setTextureFiltering(::Ogre::FilterOptions::FO_LINEAR, ::Ogre::FilterOptions::FO_LINEAR, ::Ogre::FilterOptions::FO_LINEAR);
        ::Ogre::TextureUnitState* pTex2 = pass2->createTextureUnitState();
        pTex2->setTextureName("rock_diffuse.jpg");
        pTex2->setTextureFiltering(::Ogre::FilterOptions::FO_LINEAR, ::Ogre::FilterOptions::FO_LINEAR, ::Ogre::FilterOptions::FO_LINEAR);
        ::Ogre::TextureUnitState* pTex3 = pass2->createTextureUnitState();
        pTex3->setTextureName("rock_normal.jpg");
        pTex3->setTextureFiltering(::Ogre::FilterOptions::FO_LINEAR, ::Ogre::FilterOptions::FO_LINEAR, ::Ogre::FilterOptions::FO_LINEAR);
        ::Ogre::TextureUnitState* pTex4 = pass2->createTextureUnitState();
        pTex4->setTextureName("rock_specular.png");
        pTex4->setTextureFiltering(::Ogre::FilterOptions::FO_LINEAR, ::Ogre::FilterOptions::FO_LINEAR, ::Ogre::FilterOptions::FO_LINEAR);
    }
}
